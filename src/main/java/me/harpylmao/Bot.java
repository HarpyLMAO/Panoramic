...
public class Bot {
  ...
  public Color getColor(String string) {
    ...
    if ("cyan".equals(string)) return Color.CYAN;
    if ("green".equals(string)) return Color.GREEN;
    if ("magenta".equals(string)) return Color.MAGENTA;
    if ("orange".equals(string)) return Color.ORANGE;
    if ("pink".equals(string)) return Color.PINK;
    if ("black".equals(string)) return Color.BLACK;
    if ("white".equals(string)) return Color.WHITE;

            ...
            if (event.getSelectionMenu().getId().equalsIgnoreCase("menu:help")) {
                ...
                switch (event.getValues().get(0).toLowerCase(Locale.ROOT)) {
                    case "main" -> {
                        ...
                        MessageAction mainMessage = event.getTextChannel().sendMessageEmbeds(new EmbedBuilder()
                                .setColor(panoramic.getColorColored())
                    ...
                    case "music" -> {
                        ...
                        MessageAction musicMessage = event.getTextChannel().sendMessageEmbeds(new EmbedBuilder()
                                .setColor(panoramic.getColorColored())
                    ...
                    case "cars" -> {
                        ...
                        MessageAction carsMessage = event.getTextChannel().sendMessageEmbeds(new EmbedBuilder()
                                .setColor(panoramic.getColorColored())
